...
using Content.Shared.Moonflower;
...
namespace Content.Client.PDA
{
    ...
    public sealed partial class PdaMenu : PdaWindow
    {
        ...
        public PdaMenu()
        {
            ...
            GalaxyDateTimeButton.OnPressed += _ =>
            {
                var galaxyDateTime = _timeSystem.GetGalaxyDateTime();
                _clipboard.SetText((galaxyDateTime.ToString("yyyy.MM.dd H\\:mm")));
            };
        ...
        public void UpdateState(PdaUpdateState state)
        {
            ...
            GalaxyDateTimeLabel.SetMarkup(Loc.GetString("comp-pda-ui-galaxy-datetime",
                ("datetime", galaxyDateTime.ToString("yyyy.MM.dd H\\:mm"))));
